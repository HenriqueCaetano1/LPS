...
n_hoods = 1 #numero de vizinhancas a ser utilizado
swap_number = 2 #numero de trocas de arestas a serem feitas
iter_metodo = 100
...
for i in range(iter_metodo):
    ...
    [Active_vns,Backup_vns] = vns.vns_method(Active_vns,Backup_vns,Failure,j_max,n_hoods,swap_number)
